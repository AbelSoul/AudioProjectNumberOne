...
public class AudioCapture01 extends JFrame {
	...
	public AudioCapture01() {// constructor
		final JButton captureBtn = new JButton("Gie's it!");
		final JButton stopBtn = new JButton("Stoap it");
		final JButton playBtn = new JButton("Hear it");
		...
		setTitle("Boaby's 1st Audio Proggy");
